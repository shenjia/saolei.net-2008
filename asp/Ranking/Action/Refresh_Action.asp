...
If Check_Result <> "Fail" Then
	...
	parent.document.getElementById('Ranking').innerHTML='����ˢ���������...';</script>
	<%Response.Flush()
	...
	%><script>parent.document.getElementById('Ranking').innerHTML='����ˢ���˽�����...';</script>
	<%Response.Flush()
	...
	%><script>parent.document.getElementById('Ranking').innerHTML='����ˢ�µ�������...';</script>
	<%Response.Flush()
	...
	%><script>parent.document.getElementById('Ranking').innerHTML='����ɾ�����ڶ���¼��...';</script>
	<%Response.Flush()
	...
	Call End_Conn()
	%><script>	
	parent.document.getElementById('Ranking').innerHTML='ˢ���������!!!';
	var handle;
