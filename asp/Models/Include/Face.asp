...
function Img()
 {
  ImgLink=window.prompt('ÇëÊäÈëÍ¼Æ¬Á´½Ó,ÀýÈç:http://www.saolei.net/Models/Images/Common/Logo_Chinese.gif','http://')
  if(ImgLink!='')
  {
  document.Title_Form.Title_Text.focus();
...
function Url()
 {
  Link=window.prompt('ÇëÊäÈëÍøÒ³Á´½Ó,ÀýÈç:http://www.saolei.net/','http://')
  if(Link!='')
  {
  document.Title_Form.Title_Text.focus();
