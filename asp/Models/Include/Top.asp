...
If Session("Player_Id")<>"" Then
  ...
  <script language="javascript">
    ...
    // {
    //   let src=parent.document.getElementById('Window_Video').src;
    //   let len=src.length;
    //   if(len>16&&src.substring(len-16,len)==('/play/video.html')){
    //     changeVideoPosision();
    //   }
    // }
    ...
    //   var width=document.body.clientWidth-parent.document.getElementById('Window_Video').clientWidth;
    //   parent.document.getElementById('Window_Border').style.left=width/2;
    // }
  </script>